...
@Operation(summary = "Show tables reservations by User ID")
@CustomResponseCode(responseCode = "200", description = "Successful Operation", content = @Content(array = @ArraySchema(schema = @Schema(implementation = UserReservationResponse.class))))
...
public @interface FindTableReservationsByUserApiDocs {
}
