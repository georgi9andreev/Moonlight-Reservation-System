...
@Operation(summary = "Update a car category by ID")
@CustomResponseCode(responseCode = "200", description = "Successful Operation", content = @Content( schema = @Schema(implementation = CarCategoryResponse.class)))
...
public @interface UpdateCarCategoryApiDocs {
}
