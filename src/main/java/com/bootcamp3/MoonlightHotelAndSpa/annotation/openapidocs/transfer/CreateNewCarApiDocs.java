...
@CustomResponseCode(responseCode = "201", description = "Successful Operation", content = @Content( schema = @Schema(implementation = CarResponse.class)))
...
public @interface CreateNewCarApiDocs {
}
