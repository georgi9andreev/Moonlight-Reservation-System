...
@Operation(summary = "List car transfers")
@CustomResponseCode(responseCode = "200", description = "Successful Operation", content = @Content( array = @ArraySchema(schema = @Schema(implementation = CarTransferResponse.class))))
...
public @interface GetCarTransfersApiDocs {
}
